...
# import mysql_conf as myconf
from pyspark.sql.types import StringType, StructType, IntegerType, FloatType, DateType,StructField,LongType
...
#    .writeStream\
#    .format("csv")\
#    .option("path","hdfs://Cnt7-naya-cdh63:8020/user/hive/yad2")\
#    .option("checkpointLocation","hdfs://Cnt7-naya-cdh63:8020/user/hive/yad2")\
#    .outputMode("append")\
#    .start()
